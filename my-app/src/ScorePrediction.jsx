          ...
          <form action="/" method="post">
            <div id="first">    
              ...
              <div className="f">
                  ...
                  <select
                    className="f1"
                    value={selectedBatter} // Value should be the state variable (selectedBatter)
                    onChange={(e) => setSelectedBatter(e.target.value)} // Update state when selection changes
                  >
                    <option value="" disabled>Select a non-striker</option>  {/* Optional placeholder option */}
                    {batter.map((option, index) => (
                      <option key={index} value={option}>
                        {option}
                      </option>
              ...
              <div className="f">
                ...
                <input
                placeholder="Enter no of wickets left"
                  className="f1"
                  type="number"
                  name="Wickets"
                  min="0"
